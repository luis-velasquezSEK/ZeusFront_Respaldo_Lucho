...
@Component({
  selector: 'app-materiaequivalente',
  templateUrl: './materiaequivalente.component.html',
  styleUrls: ['./materiaequivalente.component.scss']
})
export class MateriaequivalenteComponent implements OnInit {
  ...
  escogerMateria(item) {
    ...
    this.planEstudioService.setEquivalenteInput(this.lstMateriaToEmit);

    console.log('lstMateriaToEmit: ' + JSON.stringify(this.lstMateriaToEmit));
