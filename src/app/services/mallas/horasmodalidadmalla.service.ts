...
export class HorasModalidadMallaService {
  constructor(private http: HttpClient) {
  }

  url = `${environment.HOST}/`;
  endpoint: string = 'horas-modalidad-malla';
  ...
  findByModalidadMallaId(key):Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByModalidadMallaId/' + key);
  }
