...
export class MallaService {
  ...
  getAllLazy(params) {
      return this.http.get<any>(this.url + this.endpoint + '/GetAll', {params: params}).toPromise();
  }
  ...
  GetByIdPlanEstudio(codPlan, idMod): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/GetByIdPlanEstudio/' + codPlan + '/' + idMod);
  }
