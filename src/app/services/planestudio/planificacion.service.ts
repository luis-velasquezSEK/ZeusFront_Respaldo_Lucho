...
export class PlanificacionService {
  ...
  endpoint: string = 'api/planificacion';
  ...
  getAllMateriasPlanificadas(periodo: number, planEst: number, modal: number): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/GetAll/' + periodo  + '/' + planEst  + '/' + modal)
  }
  ...
  editObject(obj): Observable<any> {
    return this.http.put(this.url + this.endpoint + '/Update/' +obj.idUser, obj);
  }
