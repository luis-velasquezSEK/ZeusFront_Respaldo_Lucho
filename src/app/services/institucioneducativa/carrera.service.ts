...
export class CarreraService {
  ...
  findByFacultad(key): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/GetByIdFacultad/' + key);
  }

  getById(key): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/GetById/' + key);
  }
