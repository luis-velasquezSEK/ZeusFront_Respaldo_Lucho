...
export class CiudadService {
  ...
  getByIdCanton(idCanton): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdCanton/' + idCanton);
  }

  getByIdParroquia(idParroquia): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdParroquia/' + idParroquia);
  }
