...
export class ParroquiaService {
  ...
  getAllDisponibles(): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/disponible');
  }

  getAllDisponiblesByIDCiudad(idCiudad): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/disponibleCiudad/' + idCiudad);
  }

  getByIdCanton(idcanton): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/GetByIdCanton/' + idcanton);
  }

  getByIdCiudad(idCiudad): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdCiudad/' + idCiudad);
  }
