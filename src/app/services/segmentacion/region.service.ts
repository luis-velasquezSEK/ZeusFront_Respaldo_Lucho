...
export class RegionService {
  ...
  getByIdPais(idPais): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdPais/' + idPais);
  }

  getByIdProvincia(idProvincia): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdProvincia/' + idProvincia);
  }
