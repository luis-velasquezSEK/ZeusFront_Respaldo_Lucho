...
export class NivelInfraestructuraService {
  constructor(private http: HttpClient) {
  }

  url = `${environment.HOST}/`;
  endpoint: string = 'api/nivel-infraestructura';
  ...
  getByIdInfraestructura(key): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdInfraestructura/' + key);
  }
