...
export class EspacioService {
  ...
  endpoint: string = 'api/espacios-fisicos';
  ...
  getByIdNivel(key): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByIdINivel/' + key);
  }

  getByCodigo(key): Observable<any> {
    return this.http.get(this.url + this.endpoint + '/findByCod/' + key);
  }
